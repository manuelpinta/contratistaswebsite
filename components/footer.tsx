    ...
    <footer className="relative border-t border-border/40 bg-gradient-to-b from-background to-muted/20 overflow-hidden">
      ...
      <div className="container relative mx-auto px-4 py-16 lg:px-8">
        <div className="grid gap-12 md:grid-cols-4">
          <div className="md:col-span-2">
            <div className="mb-6 flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-xl font-bold text-foreground">{t.footer.contestTitle}</span>
                <span className="text-xs text-muted-foreground font-semibold">{t.footer.companyName}</span>
              </div>
            </div>
          ...
          <div>
            <h3 className="mb-6 text-sm font-bold text-foreground uppercase tracking-wider">{t.footer.program}</h3>
          ...
          <div>
            <h3 className="mb-6 text-sm font-bold text-foreground uppercase tracking-wider">{t.footer.support}</h3>
            <ul className="space-y-3 text-sm">
              <li>
        ...
        <div className="mt-16 border-t border-border/40 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground font-medium">
            © {new Date().getFullYear()} {t.footer.contestTitle}. {t.footer.allRightsReserved}.
          </p>
